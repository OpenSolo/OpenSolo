...
#define MAVLINK_MSG_ID_GPS_ACCURACY_MIN_LEN 22
#define MAVLINK_MSG_ID_225_LEN 22
#define MAVLINK_MSG_ID_225_MIN_LEN 22
                               ...
                               uint8_t instance, float h_acc, float s_acc, float h_vel_filt, float v_vel_filt, float p_drift, uint8_t ekf_check_mask)
{
    ...
    return mavlink_finalize_message(msg, system_id, component_id, MAVLINK_MSG_ID_GPS_ACCURACY_MIN_LEN, MAVLINK_MSG_ID_GPS_ACCURACY_LEN, MAVLINK_MSG_ID_GPS_ACCURACY_CRC);
}
                                   ...
                                   uint8_t instance,float h_acc,float s_acc,float h_vel_filt,float v_vel_filt,float p_drift,uint8_t ekf_check_mask)
{
    ...
    msg->msgid = MAVLINK_MSG_ID_GPS_ACCURACY;
    return mavlink_finalize_message_chan(msg, system_id, component_id, chan, MAVLINK_MSG_ID_GPS_ACCURACY_MIN_LEN, MAVLINK_MSG_ID_GPS_ACCURACY_LEN, MAVLINK_MSG_ID_GPS_ACCURACY_CRC);
}
...
static inline void mavlink_msg_gps_accuracy_send(mavlink_channel_t chan, uint8_t instance, float h_acc, float s_acc, float h_vel_filt, float v_vel_filt, float p_drift, uint8_t ekf_check_mask)
{
    ...
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_GPS_ACCURACY, buf, MAVLINK_MSG_ID_GPS_ACCURACY_MIN_LEN, MAVLINK_MSG_ID_GPS_ACCURACY_LEN, MAVLINK_MSG_ID_GPS_ACCURACY_CRC);
#else
    mavlink_gps_accuracy_t packet;
    packet.h_acc = h_acc;
    packet.s_acc = s_acc;
    ...
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_GPS_ACCURACY, (const char *)&packet, MAVLINK_MSG_ID_GPS_ACCURACY_MIN_LEN, MAVLINK_MSG_ID_GPS_ACCURACY_LEN, MAVLINK_MSG_ID_GPS_ACCURACY_CRC);
#endif
}
 ...
 */
static inline void mavlink_msg_gps_accuracy_send_struct(mavlink_channel_t chan, const mavlink_gps_accuracy_t* gps_accuracy)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    mavlink_msg_gps_accuracy_send(chan, gps_accuracy->instance, gps_accuracy->h_acc, gps_accuracy->s_acc, gps_accuracy->h_vel_filt, gps_accuracy->v_vel_filt, gps_accuracy->p_drift, gps_accuracy->ekf_check_mask);
#else
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_GPS_ACCURACY, (const char *)gps_accuracy, MAVLINK_MSG_ID_GPS_ACCURACY_MIN_LEN, MAVLINK_MSG_ID_GPS_ACCURACY_LEN, MAVLINK_MSG_ID_GPS_ACCURACY_CRC);
#endif
}
...
#else
        uint8_t len = msg->len < MAVLINK_MSG_ID_GPS_ACCURACY_LEN? msg->len : MAVLINK_MSG_ID_GPS_ACCURACY_LEN;
        memset(gps_accuracy, 0, MAVLINK_MSG_ID_GPS_ACCURACY_LEN);
    memcpy(gps_accuracy, _MAV_PAYLOAD(msg), len);
#endif
}

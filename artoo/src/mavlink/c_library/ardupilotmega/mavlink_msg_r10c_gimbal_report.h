...
#define MAVLINK_MSG_ID_R10C_GIMBAL_REPORT_MIN_LEN 22
#define MAVLINK_MSG_ID_224_LEN 22
#define MAVLINK_MSG_ID_224_MIN_LEN 22
                               ...
                               uint8_t target_system, uint8_t target_component, int32_t pitch_ref, int32_t roll_out, int32_t pitch_out, uint32_t roll_pwm, uint32_t pitch_pwm)
{
    ...
    return mavlink_finalize_message(msg, system_id, component_id, MAVLINK_MSG_ID_R10C_GIMBAL_REPORT_MIN_LEN, MAVLINK_MSG_ID_R10C_GIMBAL_REPORT_LEN, MAVLINK_MSG_ID_R10C_GIMBAL_REPORT_CRC);
}
                                   ...
                                   uint8_t target_system,uint8_t target_component,int32_t pitch_ref,int32_t roll_out,int32_t pitch_out,uint32_t roll_pwm,uint32_t pitch_pwm)
{
    ...
    msg->msgid = MAVLINK_MSG_ID_R10C_GIMBAL_REPORT;
    return mavlink_finalize_message_chan(msg, system_id, component_id, chan, MAVLINK_MSG_ID_R10C_GIMBAL_REPORT_MIN_LEN, MAVLINK_MSG_ID_R10C_GIMBAL_REPORT_LEN, MAVLINK_MSG_ID_R10C_GIMBAL_REPORT_CRC);
}
...
static inline void mavlink_msg_r10c_gimbal_report_send(mavlink_channel_t chan, uint8_t target_system, uint8_t target_component, int32_t pitch_ref, int32_t roll_out, int32_t pitch_out, uint32_t roll_pwm, uint32_t pitch_pwm)
{
    ...
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_R10C_GIMBAL_REPORT, buf, MAVLINK_MSG_ID_R10C_GIMBAL_REPORT_MIN_LEN, MAVLINK_MSG_ID_R10C_GIMBAL_REPORT_LEN, MAVLINK_MSG_ID_R10C_GIMBAL_REPORT_CRC);
#else
    mavlink_r10c_gimbal_report_t packet;
    packet.pitch_ref = pitch_ref;
    packet.roll_out = roll_out;
    ...
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_R10C_GIMBAL_REPORT, (const char *)&packet, MAVLINK_MSG_ID_R10C_GIMBAL_REPORT_MIN_LEN, MAVLINK_MSG_ID_R10C_GIMBAL_REPORT_LEN, MAVLINK_MSG_ID_R10C_GIMBAL_REPORT_CRC);
#endif
}
 ...
 */
static inline void mavlink_msg_r10c_gimbal_report_send_struct(mavlink_channel_t chan, const mavlink_r10c_gimbal_report_t* r10c_gimbal_report)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    mavlink_msg_r10c_gimbal_report_send(chan, r10c_gimbal_report->target_system, r10c_gimbal_report->target_component, r10c_gimbal_report->pitch_ref, r10c_gimbal_report->roll_out, r10c_gimbal_report->pitch_out, r10c_gimbal_report->roll_pwm, r10c_gimbal_report->pitch_pwm);
#else
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_R10C_GIMBAL_REPORT, (const char *)r10c_gimbal_report, MAVLINK_MSG_ID_R10C_GIMBAL_REPORT_MIN_LEN, MAVLINK_MSG_ID_R10C_GIMBAL_REPORT_LEN, MAVLINK_MSG_ID_R10C_GIMBAL_REPORT_CRC);
#endif
}
...
#else
        uint8_t len = msg->len < MAVLINK_MSG_ID_R10C_GIMBAL_REPORT_LEN? msg->len : MAVLINK_MSG_ID_R10C_GIMBAL_REPORT_LEN;
        memset(r10c_gimbal_report, 0, MAVLINK_MSG_ID_R10C_GIMBAL_REPORT_LEN);
    memcpy(r10c_gimbal_report, _MAV_PAYLOAD(msg), len);
#endif
}

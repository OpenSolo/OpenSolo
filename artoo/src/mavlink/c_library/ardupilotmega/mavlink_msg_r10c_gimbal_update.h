...
#define MAVLINK_MSG_ID_R10C_GIMBAL_UPDATE_MIN_LEN 16
                               ...
                               float roll, float pitch, float yaw, float pitch_ref)
{
    ...
    return mavlink_finalize_message(msg, system_id, component_id, MAVLINK_MSG_ID_R10C_GIMBAL_UPDATE_MIN_LEN, MAVLINK_MSG_ID_R10C_GIMBAL_UPDATE_LEN, MAVLINK_MSG_ID_R10C_GIMBAL_UPDATE_CRC);
}
                                   ...
                                   float roll,float pitch,float yaw,float pitch_ref)
{
    ...
    msg->msgid = MAVLINK_MSG_ID_R10C_GIMBAL_UPDATE;
    return mavlink_finalize_message_chan(msg, system_id, component_id, chan, MAVLINK_MSG_ID_R10C_GIMBAL_UPDATE_MIN_LEN, MAVLINK_MSG_ID_R10C_GIMBAL_UPDATE_LEN, MAVLINK_MSG_ID_R10C_GIMBAL_UPDATE_CRC);
}
...
static inline void mavlink_msg_r10c_gimbal_update_send(mavlink_channel_t chan, float roll, float pitch, float yaw, float pitch_ref)
{
    ...
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_R10C_GIMBAL_UPDATE, buf, MAVLINK_MSG_ID_R10C_GIMBAL_UPDATE_MIN_LEN, MAVLINK_MSG_ID_R10C_GIMBAL_UPDATE_LEN, MAVLINK_MSG_ID_R10C_GIMBAL_UPDATE_CRC);
#else
    mavlink_r10c_gimbal_update_t packet;
    packet.roll = roll;
    packet.pitch = pitch;
    ...
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_R10C_GIMBAL_UPDATE, (const char *)&packet, MAVLINK_MSG_ID_R10C_GIMBAL_UPDATE_MIN_LEN, MAVLINK_MSG_ID_R10C_GIMBAL_UPDATE_LEN, MAVLINK_MSG_ID_R10C_GIMBAL_UPDATE_CRC);
#endif
}
 ...
 */
static inline void mavlink_msg_r10c_gimbal_update_send_struct(mavlink_channel_t chan, const mavlink_r10c_gimbal_update_t* r10c_gimbal_update)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    mavlink_msg_r10c_gimbal_update_send(chan, r10c_gimbal_update->roll, r10c_gimbal_update->pitch, r10c_gimbal_update->yaw, r10c_gimbal_update->pitch_ref);
#else
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_R10C_GIMBAL_UPDATE, (const char *)r10c_gimbal_update, MAVLINK_MSG_ID_R10C_GIMBAL_UPDATE_MIN_LEN, MAVLINK_MSG_ID_R10C_GIMBAL_UPDATE_LEN, MAVLINK_MSG_ID_R10C_GIMBAL_UPDATE_CRC);
#endif
}
...
#else
        uint8_t len = msg->len < MAVLINK_MSG_ID_R10C_GIMBAL_UPDATE_LEN? msg->len : MAVLINK_MSG_ID_R10C_GIMBAL_UPDATE_LEN;
        memset(r10c_gimbal_update, 0, MAVLINK_MSG_ID_R10C_GIMBAL_UPDATE_LEN);
    memcpy(r10c_gimbal_update, _MAV_PAYLOAD(msg), len);
#endif
}
